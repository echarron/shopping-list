...
public class UsersResourceTest {
    ...
    should_retrieve_a_list() {
        ...
        User expectedUser = new User(userId, "test@test.fr", "test", "password", newArrayList(expectedList));
        given(userRepository.get(userId)).willReturn(expectedUser);
    ...
    should_add_one_product_to_a_list() {
        ...
        User expectedUser = new User(userId, "test@test.fr", "test", "password", newArrayList(new ShoppingList(listId, "Romantic dinner")));
        given(userRepository.get(userId)).willReturn(expectedUser);
